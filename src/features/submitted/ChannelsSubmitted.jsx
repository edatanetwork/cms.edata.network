...
} from 'features/submitted/channelsSubmittedApiSlice'
...
const ChannelsSubmitted = () => {
  ...
  const [markSeen] = useMarkSeenSubmittedChannelMutation()
  const [deleteSubmittedSport] = useDeleteChannelMutation()

  const { data, ...rest } = useGetSubmittedChannelsQuery({ ...params })
...
export default ChannelsSubmitted
